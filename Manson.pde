...
class Manson{
  ...
  Manson(int _manson_ID)
  {
    ...
    action = Action_Type.MANSON_STOP;
    direction = Direction_Type.NO_DIRECTION;
  }
  
  void update_action(Action_Type _action, Direction_Type _dir){
    action = _action;
    direction = _dir;
  }
  ...
  int get_manson_action(){
    return action.getValue();
  }
  
  int get_manson_direction(){
    return direction.getValue();
  }
  
  String get_manson_MoveArrow(){
    return direction.getMoveArrow();
  }
  
  String get_manson_BuildArrow(){
    return direction.getBuildArrow();
  }
